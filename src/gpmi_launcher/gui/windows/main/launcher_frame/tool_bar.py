...
class ToolBarFrame(UIFrame):
    def __init__(self, master, canvas, **kwargs):
        ...
        self.set_background_image(width=100, height=226, x=1230, y=630, anchor='se',
        ...
        self.put(OpenPortraitManagerButton(self))
...
class OpenPortraitManagerButton(ToolsBarButton):
    def __init__(self, master):
        super().__init__(
            y=605,
    ...
    def handle_load_importer(self, event):
        self.show(event.importer_id == 'GPMI')
